...
const Login = () => {
  const {setUserLogin} = useUserLoginContextProvider();
  ...
  useEffect(() => {
    const handleUserDetail = async () => {
      try {
        ...
        console.error('Error during protected request:', error.message);
      }
    };
  ...
  return (
    <div className='h-[100vh]'>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" action="http://localhost:8000/user/login" method="POST">
            <div>
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="http://localhost:3000" className="font-semibold text-indigo-600 hover:text-indigo-500">
                    Forgot password?
                  </a>
                </div>
              </div>
